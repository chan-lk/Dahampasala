export class AppConstants {
    private static API_BASE_URL = "http://localhost:8080/springdahampasala-0.0.1-SNAPSHOT/";
    private static OAUTH2_URL = AppConstants.API_BASE_URL + "oauth2/authorization/";
    private static REDIRECT_URL = "?redirect_uri=http://localhost:8081/login";
    public static API_URL = AppConstants.API_BASE_URL + "chanlk/";
    public static AUTH_API = AppConstants.API_URL + "auth/";
    public static USER_API = AppConstants.API_URL + "fnd/user";
